#MenuTitle: Honk - Generate File For Export
__doc__="""
...
values[exporting.index(allGlyphs["N"])] = [0, 0, 0, 0, 20, 0, 0, 0, 0, 0]
values[exporting.index(allGlyphs["T"])] = [0, 0, 0, 0, 20, 0, 0, 0, 0, 0]
values[exporting.index(allGlyphs["Tbar"])] = [0, 0, 0, 0, 20, 0, 0, 0, 0, 0]
values[exporting.index(allGlyphs["B"])] = [0, 0, 0, 0, 10, 0, 0, 0, 0, 0]
values[exporting.index(allGlyphs["six"])] = [0, 0, 0, 0, 10, 0, 0, 0, 0, 0]
values[exporting.index(allGlyphs["nine"])] = [0, 0, 0, 0, 10, 0, 0, 0, 0, 0]
values[exporting.index(allGlyphs["E"])] = [6, 6, 6, 6, 18, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["S"])] = [6, 6, 6, 6, 18, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["Z"])] = [6, 6, 6, 6, 18, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["zero"])] = [6, 6, 6, 6, 18, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["two"])] = [6, 6, 6, 6, 18, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["three"])] = [6, 6, 6, 6, 18, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["five"])] = [6, 6, 6, 6, 18, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["F"])] = [6, 6, 6, 6, 18, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["J"])] = [6, 6, 6, 6, 0, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["L"])] = [6, 6, 6, 6, 0, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["seven"])] = [6, 6, 6, 6, 0, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["C"])] = [6, 6, 6, 6, 28, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["c"])] = [6, 6, 6, 6, 28, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["o"])] = [0, 0, 0, 0, 10, 0, 0, 0, 0, 0]
values[exporting.index(allGlyphs["a"])] = [6, 6, 6, 6, 18, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["e"])] = [6, 6, 6, 6, 18, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["s"])] = [6, 6, 6, 6, 18, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["z"])] = [6, 6, 6, 6, 18, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["guilsinglleft"])] = [28, 0, 34, 16, 35, 30, 10, 28, 20, 20]
values[exporting.index(allGlyphs["guilsinglright"])] = [28, 0, 34, 16, 35, 30, 10, 28, 20, 20]
values[exporting.index(allGlyphs["guillemetleft"])] = [125, 95, 138, 113, 138, 130, 100, 128, 128, 113]
values[exporting.index(allGlyphs["guillemetright"])] = [125, 95, 138, 113, 138, 130, 100, 128, 128, 113]
values[exporting.index(allGlyphs["semicolon"])] = [66, 66, 66, 66, 66, 66, 66, 66, 70, 66]
values[exporting.index(allGlyphs["exclamdown"])] = [66, 66, 66, 66, 66, 66, 66, 66, 70, 66]
...
values[exporting.index(allGlyphs["dieresiscomb.narrow"])] = [15, 20, 47, 18, 20, 15, 15, 15, 18, 28]
...
values[exporting.index(allGlyphs["dblgravecomb.narrow"])] = [24, 18, 50, 16, 20, 22, 20, 24, 39, 36]
...
values[exporting.index(allGlyphs["circumflexcomb.narrow"])] = [28, 26, 50, 16, 18, 20, 28, 18, 26, 38]
...
values[exporting.index(allGlyphs["Lcaron"])] = [6, 6, 6, 6, 0, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["Ldot"])] = [6, 6, 6, 6, 0, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["Lslash"])] = [6, 6, 6, 6, 0, 6, 6, 6, 6, 6]
values[exporting.index(allGlyphs["Germandbls"])] = [0, 0, 0, 0, 10, 0, 0, 0, 0, 0]
values[exporting.index(allGlyphs["germandbls"])] = [0, 0, 0, 0, 10, 0, 0, 0, 0, 0]
values[exporting.index(allGlyphs["Tbar"])] = [0, 0, 0, 0, 20, 0, 0, 0, 0, 0]
values[exporting.index(allGlyphs["schwa"])] = [6, 6, 6, 6, 18, 6, 6, 6, 6, 6] 
values[exporting.index(allGlyphs["question"])] = [0, 0, 27, 0, 0, 0, 0, 0, 0, 0]
values[exporting.index(allGlyphs["tbar"])] = [0, 0, 3, 0, 0, 2, 2, 0, 0, 5]
values[exporting.index(allGlyphs["lslash"])] = [35, 30, 55, 30, 54, 34, 32, 32, 30, 22]
values[exporting.index(allGlyphs["numero"])] = [22, 22, 22, 22, 22, 12, 12, 6, 12, 22]
values[exporting.index(allGlyphs["peseta"])] = [22, 22, 22, 22, 22, 12, 12, 6, 12, 22]
values[exporting.index(allGlyphs["idotless"])] = [44, 56, 14, 28, 16, 52, 28, 42, 40, 36]
...
#is flip?
flipH = ["W", "w"]
flipV = ["four", "d", "q", "gravecomb", "gravecomb.narrow", "dblgravecomb", "dblgravecomb.narrow", "macrongravecomb", "circumflexgravecomb", "brevegravecomb", "eng", "macrongravecomb"]
isFlipH = [False for g in exporting]
...
below = ["dotbelowcomb", "dieresisbelowcomb", "commaaccentcomb", "cedillacomb", "ogonekcomb", "brevebelowcomb", "macronbelowcomb", "ogonekcomb.narrow", "macronbelowcomb.narrow"]
...
otherGlyphs = ["DZ", "Dz", "LJ", "Lj", "NJ", "Nj", "dz", "lj", "nj", "fi", "fl", "DZcaron", "Dzcaron", "dzcaron", "dcaron", "lcaron", "IJ", "ij"]

def addBg(glyphname, compname, values, factorX, factorY, isFlipH, isFlipV): #adds backgrounds to all glyphs in input list
	...
	while i < len(diacriticGlyphs):
		...
		for thisLayer in thisGlyph.layers:
			...
			if thisGlyph.name in rightalign:
				...
				element.x = allGlyphs[letter].layers[thisGlyph.layers.index(thisLayer)].width - element.bounds.size.width - x
...
#add backgrounds to all exporting glyphs
...
for thisGlyph in allGlyphs:
	...
	if (thisGlyph.name in compNames) or (thisGlyph.name in markNames) or (thisGlyph.name in shadowNames) or (thisGlyph.name=='symbol'):
